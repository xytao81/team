...
__DEFINE__(1558083445779, function(require, module, exports) {
/**
 * we-cropper v1.3.7
 * (c) 2019 dlhandsome
 * @license MIT
...
function prepare () {
  ...
  self.attachPage = function (pageContext = null) {
    // 获取到当前page上下文
    if (!pageContext) {
      let pages = getCurrentPages();
      pageContext = pages[pages.length - 1];
    }
...
var WeCropper = function WeCropper (params, pageContext = null) {
  var self = this;
  var _default = {};
...
return __REQUIRE__(1558083445779);
})()
